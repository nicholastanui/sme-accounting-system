...
use App\V1\Data\CustomerExpenseData;
use PDO;

/**
 * Repository.
 */
final class AllCustomerExpensesGetterRepository
{
  ...
  public function __construct(PDO $connection)
  {
     ...
     */
    public function findExpenses($id): array
    {
      try {
            $sql='SELECT * FROM expenses WHERE company_id=:company_id ORDER By id DESC';
          ...
          return $this->hydrate($customers,CustomerExpenseData::class);
