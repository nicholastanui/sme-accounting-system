...
use App\V1\Data\CompanyServiceData;
use PDO;

/**
 * Repository.
 */
final class AllCompanyServicesGetterRepository
{
  ...
  public function __construct(PDO $connection)
  {
     ...
     */
    public function findServices($id): array
    {
      try {
            $sql='SELECT * FROM company_services WHERE company_id=:company_id ORDER By id DESC';
          ...
          return $this->hydrate($periods,CompanyServiceData::class);
