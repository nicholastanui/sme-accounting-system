 ...
 * Repository.
 */
final class AllCompanyUsersGetterRepository
{
  ...
  public function __construct(PDO $connection)
  {
     ...
     */
    public function findUsers($id): array
    {
      try {
            $sql='SELECT * FROM users WHERE company_id=:company_id ORDER By id DESC';
          ...
          return $this->hydrate($customers,UserData::class);
