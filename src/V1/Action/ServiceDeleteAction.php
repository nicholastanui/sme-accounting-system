...
use App\V1\Main\ServiceDeleter;
 ...
 * Action.
 */
final class ServiceDeleteAction
{
    private ServiceDeleter $serviceDeleter;
  ...
  //  private Responder $responder;
     ...
     */
    public function __construct(ServiceDeleter $serviceDeleter)
    {
